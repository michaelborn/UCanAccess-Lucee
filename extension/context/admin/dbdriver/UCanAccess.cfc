component extends="types.Driver" output="no" implements="types.IDatasource" {
	...
	this.className="net.ucanaccess.jdbc.UcanaccessDriver";
	this.bundleName="net.ucanaccess.jdbc";
	this.dsn="jdbc:ucanaccess:///{file}";
	...
	*/
	public string function getDescription() {
		return "JDBC Driver for the MS Access database.";
	}
